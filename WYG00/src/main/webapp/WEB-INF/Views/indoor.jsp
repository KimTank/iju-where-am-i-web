			...
			<div class="navbar-translate">
				<table style="width: 580px">
					<tr style="width: 580px">
						...
						<td><a  style="width: 100px"class="navbar-brand; b;" href="Indoor.jsp"
							>Indoor</a></td>
							<td style="width: 70px"></td>
						<td><a  style="width: 100px"class="navbar-brand; b;" href="index.jsp"
							rel="tooltip" data-placement="bottom">IRTLS</a></td>
							<td style="width: 70px"></td>
						<td><a  style="width: 100px"class="navbar-brand; b;" href="index.jsp"
			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" rel="tooltip"
						...
						href="https://www.facebook.com/sycork" target="_blank"> <i
	...
	<div class="wrapper">
		<div class="page-header clear-filter" filter-color="orange">
			<div class="page-header-image" data-parallax="true"
				style="background-image: url('./assets/img/zzz1.jpg');"></div>
			<div class="container">
				<div class="content-center brand">
					<h3>당신의 사업장을 위한 맞춤 Indoor Real Time Location System</h3>
				</div>
			</div>
		</div>
		<!-- 두번째  -->
