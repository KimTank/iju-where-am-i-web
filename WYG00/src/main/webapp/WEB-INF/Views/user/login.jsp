		...
		<div class="container">
			<div class="col-md-4 content-center">
				<div class="card card-login card-plain">
					<form class="form" method="post" action="t2loginInfor"
						style="width: auto;">
						...
						<div class="content">
							...
							<div class="input-group form-group-no-border input-lg">
								...
								</span> <input type="password" placeholder="비밀번호" class="form-control"
									id="ipass" name="pass" />
							</div>
						</div>
						<div class="footer text-center">
							<button type="submit"
								class="btn btn-primary btn-round btn-lg btn-block" id="ibtn">로그인</button>
						</div>
					</form>
					<div class="pull-center">
						<h6>
							<a href="t1signup" class="link">회원 가입</a>
						</h6>
					</div>
				</div>
			</div>
