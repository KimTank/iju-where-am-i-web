...
<body class="index-page sidebar-collapse">
	...
	<div class="wrapper">
		<div class="page-header clear-filter" filter-color="orange">
			<!-- 배경그림 -->
			<%if(id==null){ %>
			<div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/kkk1.jpg');"></div>
			<%} else {%>
			<div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/loginS.jpg');"></div>
			<%} %>
			<div class="container">
				<div class="content-center brand">
					...
					%>
					<h3>
						당신의 사업장을 위한 맞춤 Indoor Real Time Location System</br> Indoor 관측 시스템사용을 위하여 로그인을 해주세요
					</h3>
					<%
					} else {
					%>
